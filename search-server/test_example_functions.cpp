...
std::ostream& operator<< (std::ostream& out, const std::vector<std::string_view>& collection){
    using namespace std;
...
void PrintMatchForDocument(const std::tuple<std::vector<std::string_view>, DocumentStatus>& matchInfo, int documentId){
    using namespace std;
